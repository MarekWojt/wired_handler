...
fn test() {
    // forward
    {
        ...
        assert_eq!(Some(""), remaining_path.peek());
        assert_eq!(Some(""), remaining_path.next().as_deref());
        assert_eq!(None, remaining_path.peek());
...

    {
        ...
        let remaining_path = ctx.remaining_path_mut();
        assert_eq!(Some("test"), remaining_path.peek());
...

    {
        ...
        assert_eq!(Some("test"), remaining_path.peek());
        assert_eq!(Some("test"), remaining_path.next().as_deref());
        assert_eq!(Some("bla"), remaining_path.peek());
...

    {
        ...
        assert_eq!(Some("test"), remaining_path.peek());
        assert_eq!(Some("test"), remaining_path.next().as_deref());
        assert_eq!(Some("first"), remaining_path.peek());
        assert_eq!(Some("first"), remaining_path.next().as_deref());
        assert_eq!(Some("second"), remaining_path.peek());
        assert_eq!(Some("second"), remaining_path.next().as_deref());
        assert_eq!(Some("last"), remaining_path.peek());
    ...
    // backwards
    {
        let mut ctx = context_with_path("");
        let remaining_path = ctx.remaining_path_mut();
        assert_eq!(Some(""), remaining_path.peek_back());
        assert_eq!(Some(""), remaining_path.next_back().as_deref());
        assert_eq!(None, remaining_path.peek_back());
...

    {
        let mut ctx = context_with_path("/test");
        let remaining_path = ctx.remaining_path_mut();
        assert_eq!(Some("test"), remaining_path.peek_back());
...

    {
        let mut ctx = context_with_path("/test/bla");
        let remaining_path = ctx.remaining_path_mut();
        assert_eq!(Some("bla"), remaining_path.peek_back());
...

    {
        let mut ctx = context_with_path("/test/first/second/last");
        let remaining_path = ctx.remaining_path_mut();
        assert_eq!(Some("last"), remaining_path.peek_back());
        assert_eq!(Some("last"), remaining_path.next_back().as_deref());
        assert_eq!(Some("second"), remaining_path.peek_back());
        assert_eq!(Some("second"), remaining_path.next_back().as_deref());
        assert_eq!(Some("first"), remaining_path.peek_back());
